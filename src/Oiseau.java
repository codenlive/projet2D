...
public class Oiseau extends Prey {
	...
	public void moveDefault1() {
		...
		// int i;
		switch (orient) { // eau0, oiseau40,sable1
		case 0: // nord
			if (SpriteDemo.myWorld[posi][(posj - 1 + 64) % 64] == 0
					|| SpriteDemo.myWorld[posi][(posj - 1 + 64) % 64] == 2) {
		...
		case 1: // est
			if (SpriteDemo.myWorld[(posi + 1 + 120) % 120][posj] == 0
					|| SpriteDemo.myWorld[(posi + 1 + 120) % 120][posj] == 2) {
		...
		case 4: // nord-est
			if (SpriteDemo.myWorld[(posi + 1 + 120) % 120][(posj - 1 + 64) % 64] == 0
					|| SpriteDemo.myWorld[(posj - 1 + 120) % 120][(posj - 1 + 64) % 64] == 2) {
		...
		case 5: // nord-ouest
			if (SpriteDemo.myWorld[(posi - 1 + 120) % 120][(posj - 1 + 64) % 64] == 0
					|| SpriteDemo.myWorld[(posi - 1 + 120) % 120][posj - 1 + 64 % 64] == 2) {
				SpriteDemo.newmyWorld[(posi - 1 + 120) % 120][(posj - 1 + 64) % 64] = 40;
				if (SpriteDemo.myWorld[(posi - 1 + 120) % 120][(posj - 1 + 64) % 64] == 2) {
					SpriteDemo.newmyWorld[posi][posj] = 2;
				} else {
