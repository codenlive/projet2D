...
public class Lion extends Predator {
	...
	public void moveDefault(){
		...
		int cpt=0;
		int cpt2=0;
		if(SpriteDemo.myWorld[posi-1][posj-1]==80||SpriteDemo.myWorld[posi][posj-1]==80||SpriteDemo.myWorld[posi+1][posj-1]==80||SpriteDemo.myWorld[posi-1][posj]==80||SpriteDemo.myWorld[posi+1][posj]==580||SpriteDemo.myWorld[posi-1][posj+1]==80||SpriteDemo.myWorld[posi][posj+1]==80||SpriteDemo.myWorld[posi+1][posj+1]==80){
					
			// nord
			
		  if(SpriteDemo.myWorld[posi][posj-1]==80&&cpt==0){
		   		
		   		SpriteDemo.newmyWorld[posi][posj-1]=6;
		   		
		   	if(SpriteDemo.myWorld[posi][posj-1]==80){
		   	...
		   	// est
		if(SpriteDemo.myWorld[posi+1][posj]==80&&cpt==0){
			
			SpriteDemo.newmyWorld[posi+1][posj]=6;
			if(SpriteDemo.myWorld[posi+1][posj]==80){
				SpriteDemo.newmyWorld[posi][posj]=2;
			}
		cpt++;
		}
	 ...
	 // nord-est
		if(SpriteDemo.myWorld[posi+1][posj-1]==80&&cpt==0){

			SpriteDemo.newmyWorld[posi+1][posj-1]=6;
		
			if(SpriteDemo.myWorld[posi+1][posj-1]==80){
				SpriteDemo.newmyWorld[posi][posj]=2;
			}
		...
		if(SpriteDemo.myWorld[posi-1][posj+1]==80&&cpt==0){
		 ...
		 {
	     	case 0: // nord
	     		   		if((SpriteDemo.myWorld[posi][posj-1]==2||SpriteDemo.myWorld[posi][posj-1]==78||SpriteDemo.myWorld[posi][posj-1]==80)&&cpt==0){
	     	...
	     	case 1:	// est
	     		if((SpriteDemo.myWorld[posi+1][posj]==2||SpriteDemo.myWorld[posi+1][posj]==78||SpriteDemo.myWorld[posi+1][posj]==80)&&cpt==0){
	     	...
	     	case 4: // nord-est
	     		if((SpriteDemo.myWorld[posi+1][posj-1]==2||SpriteDemo.myWorld[posi+1][posj-1]==78||SpriteDemo.myWorld[posi+1][posj-1]==80)&&cpt==0){
		 ...
		 if(SpriteDemo.myWorld[posi][posj-1]==38&&cpt2==0){
		   	...
		   	// est
		if(SpriteDemo.myWorld[posi+1][posj]==38&&cpt2==0){
	 ...
	 // nord-est
		if(SpriteDemo.myWorld[posi+1][posj-1]==38&&cpt2==0){
	...
	*/
	...
	/*public void eat() {
		...
		for (Mouton i : Agent.moutons ) {// a modifier pour rajouter espece que
										// le lion peut manger
			if (posTypeAgentNorthEast()[2] == 38 && compteur_mange < 1) {
				i.meurt();
			...
			if (posTypeAgentNorth()[2] == 38 && compteur_mange < 1) {
				i.meurt();
				this.reserve_food += 15;
				this.reserve_eau += 5;
				compteur_mange++;
			...
			if (posTypeAgentEast()[2] == 38 && compteur_mange < 1) {
				i.meurt();
				this.reserve_food += 15;
				this.reserve_eau += 5;
				compteur_mange++;
			...
			if (posTypeAgentSouthEast()[2] == 38 && compteur_mange < 1) {
				i.meurt();
				this.reserve_food += 15;
				this.reserve_eau += 5;
			...
			if (posTypeAgentSouth()[2] == 38 && compteur_mange < 1) {
				i.meurt();
				this.reserve_food += 15;
				this.reserve_eau += 5;
				compteur_mange++;
			...
			if (posTypeAgentSouthWest()[2] == 38 && compteur_mange < 1) {
				i.meurt();
				this.reserve_food += 15;
				this.reserve_eau += 5;
				compteur_mange++;
			...
			if (posTypeAgentWest()[2] == 38 && compteur_mange < 1) {
				i.meurt();
				this.reserve_food += 15;
				this.reserve_eau += 5;
				compteur_mange++;
			...
			if (posTypeAgentNorthWest()[2] == 38 && compteur_mange < 1) {
				i.meurt();
				this.reserve_food += 15;
				this.reserve_eau += 5;
				compteur_mange++;
