	  ...
	  if(i%150==0){
	   ...
	   saison=2; //hiver
		...
		for(int k=0;k!=120;k++){
			...
			l1.posi=k;l1.posj=l;
			m1.posi=k;m1.posj=l;
			ins.posi=k;ins.posj=l;
			pum.posi=k;pum.posj=l;
			bic.posi=k;bic.posj=l;
			...
			if(myWorld[k][l]==38){m1.eat();m1.moveDefault();}
			if(myWorld[k][l]==27){ins.moveDefault();ins.autoReproduce();}
			if(myWorld[k][l]==35){pum.moveDefault();}
			if(myWorld[k][l]==37){bic.eat();bic.moveDefault();}
